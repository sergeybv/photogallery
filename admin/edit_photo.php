...
<?php
  ...
  $photo = Photo::find_by_id($_GET['id']);
    ...
    if(isset($_POST['update'])){
      ...
      $photo->title = htmlspecialchars(trim($_POST['title']));
      $photo->caption = htmlspecialchars(trim($_POST['caption']));
      $photo->alternate_text = htmlspecialchars(trim($_POST['alternate_text']));
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Edit Photos <small>Statistics Overview</small>
                    </h1>
                        ...
                        <div class="col-md-4">
                               ...
                               <div class="photo-info-box">
                                 ...
                                 <div class="inside">
                                    <div class="box-inner">
                                      <p class="text">
                                      <span class="glyphicon glyphicon-calendar"></span> Uploaded on: Febr. 10, 2016 @ 5:16
                                      </p>
                                      <p class="text">
                                      ...
                                      <p class="text">
                                        File Size: <span class="data">3254345</span>
                                      </p>
                                    </div>
